	    ...
	    public function domenu() {
	    	if(simplelender_fs()->is_plan('growth')){
		        ...
		        $menu_html.="<div class='sl_menu_html wrap'><ul class='subsubsub' >";
						$menu_html.= "<li> <a class='' href=".mvc_admin_url(array('controller' => 'admin_simplelender_messages', 'action' => 'index',)).">Ticketing</a></li>";
						$menu_html.= '<li> <a class=""  href="'.mvc_admin_url(array("controller" => "simplelender_webhooks", "action" => "index", "id" =>"" )).'">All Custom Email(s)</a></li>';
	  					$menu_html.= "<li> <a class='' href=".mvc_admin_url(array('controller' => 'admin_simplelender_mailchimps', 'action' => 'index',)).">Mailchimp Settings</a></li>";
		        $menu_html.="</ul></div>";
		    }
		    else{
		    	$menu_html='';
