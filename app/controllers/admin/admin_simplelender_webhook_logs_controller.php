<?php
	...
	class AdminSimplelenderWebhookLogsController extends MvcAdminController {
	    ...
	    public function domenu() {
			...
			$menu_html.='<div>
					<span class="wp-core-ui button-primary" ><a class="simplelender_menu_item_a"  href="'.mvc_admin_url(array("controller" => "simplelender_webhooks", "action" => "index", "id" =>"2" )).'">APIs</a></span>
				</div>';
