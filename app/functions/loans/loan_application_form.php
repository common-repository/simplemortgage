...
class simplelender_gravity_form_manager {
    ...
    public function return_primary_form($param=''){ //template for primary
		...
		if(array_key_exists('simplelenderLoansetting',$param)){
    ...
    public function primary_to_secondary(){//template for secondary
		...
		//echo "secondary!";
        $this->sl_display_html = '<center><div class="sl_gform_manager">'.do_shortcode('[gravityform id="'.$gf_id.'" title="flase" description="false" ajax="false"]').'</div></center>';
    }
    ...
    public function secondary_to_goal(){//template for goal
		...
		//echo "goal!";
        $this->sl_display_html = '<center><div class="sl_gform_manager">'.do_shortcode('[gravityform id="'.$gf_id.'" title="false" description="false" ajax="false"]').'</div></center>';
    }
    ...
    public function display_form_for_loan($atts){ //primary / secondary
		...
		if(array_key_exists("simplelender",$_SESSION)){
			$loan_session = $_SESSION["simplelender"]["pending_processes"]["loan_application_process"];
		}
		else{$loan_session =[];}
    ...
    public function submit_form_for_loan($form="f", $entries="e"){
		if(!array_key_exists('primary_to_secondary',$_SESSION["simplelender"]["pending_processes"]["loan_application_process"])){
			$_SESSION["simplelender"]["pending_processes"]["loan_application_process"]['primary_to_secondary'] = false;
		}
