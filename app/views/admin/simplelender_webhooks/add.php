...
<center><h3 class="simplelender_main_title"> New Email </h3></center>

<?php echo $this->form->create($model->name); ?>

	<div class="simplelender_title_feild">Activate Email</div>
	<div class="simplelender_title_feild"><?php echo $this->form->checkbox_input('notification_is_active',array('label' => '','value'=>1,'class'=>'simplelender_input_feild')); ?></div>
	...
	<div class="simplelender_title_feild" ><?php  
	...
	<div class="simplelender_title_feild"><?php echo $this->form->checkbox_input('mail_active',array('label' => '','class'=>'simplelender_input_feild')); ?></div>
	
	<div class="simplelender_title_feild">Email subject</div>
	<div class="simplelender_title_feild"><?php echo $this->form->input('mail_subject',array('label' => '','class'=>'simplelender_input_feild')); ?></div>

	<div class="simplelender_title_feild">Email body</div>
	<div class="simplelender_title_feild"><?php echo $this->form->editor('mail_body',array('label' => '','class'=>'simplelender_input_feild')); ?></div>
